...
alle_bundesliga_ergebnisse = requests.get(
    'https://www.openligadb.de/api/getmatchdata/bl2/2019')
# Erzeugen einer Liste aus dem Antwort-Objekt
alle_bundesliga_ergebnisse = alle_bundesliga_ergebnisse.json()
...
spielendergebnis = bestimme_endergebnis_aus_liste_mit_toren(
    alle_aktuellen_tore_als_liste)
...
for spiel in alle_bundesliga_ergebnisse:
    ...
    if team1 == "VfB Stuttgart" or team2 == "VfB stuttgart":
        ...
        if aktuelles_Datum < zeitpunkt_des_spiels:
            ...
            print("Das Spiel hat am " +
                  str(zeitpunkt_des_spiels) + " stattgefunden.")
            # Prüfung auf länge der Liste -> leere liste (länge 0) heißt das spiel ist unentschieden ausgegangen
            if len(spiel_tor_liste) == 0:
                print("Spiel ist 0:0 ausgegangen.")
            else:
                # zugriff auf erstes Tor aus der Tor Liste
        ...
        #   print("Das Spiel ist" +str(Endergebnis_des_spiels) + "ausgegangen.")
            ...
            PointsTeam2 = endspielergebnis['PointsTeam2']
            if team1 == "VfB Stuttgart" or team2 == "VfB Stuttgart":
                print("Heim:" + str(PointsTeam1) +
                      " Auswerts:" + str(PointsTeam2))
                ...
                if team1_tore > team2_tore:
                    if team1 == "VfB Stuttgart":
                        ...
                        # print("Gewonnene Spiele": + str(zaehler_fuer_siege))
                        zaehler_fuer_tore_von_vfb = zaehler_fuer_tore_von_vfb + team1_tore
                        print("Tore Insgesamt:" +
                              str(zaehler_fuer_tore_von_vfb))
                        print()
                ...
                if team1_tore > team2_tore:
                    if team1 == "VfB Stuttgart":
                        ...
                        zaehler_fuer_gewonnene_spiele = zaehler_fuer_gewonnene_spiele + 3
                        print("Gewonnene Spiele:" +
                              str(zaehler_fuer_gewonnene_spiele))
                ...
                if team1_tore == team2_tore:
                    if team1 == "VfB Stuttgart":
                        ...
                        zaehler_fuer_Unentschiede_spiele = zaehler_fuer_Unentschiede_spiele + 1
                        print("Unentschiedene Spiele:" +
                              str(zaehler_fuer_Unentschiede_spiele))
                ...
                if team1_tore < team2_tore:
                    if team1 == "VfB Stuttgart":
                        ...
                        zaehler_fuer_verlorene_spiele = zaehler_fuer_verlorene_spiele + 1
                        print("Verlorene Spiele:" +
                              str(zaehler_fuer_verlorene_spiele))
